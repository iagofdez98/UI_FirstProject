		...
		?>
			...
			<form name = 'Form' action='../Controller/PROF_TITULACION_Controller.php' method='post' onsubmit="return comprobar_registro();">
					...
					<span class="trn">CODTITULACION</span>:  
						<input type = 'text' name = 'CODTITULACION' id = 'CODTITULACION' placeholder = 'Utiliza tu DNI' size = '10' value = ''  onblur="validarTexto(this, 9)"><br>

					<span class="trn">ANHOACADEMICO</span>: 
						<input type = 'text' name = 'ANHOACADEMICO' id = 'ANHOACADEMICO' placeholder = 'Utiliza tu DNI' size = '9' value = '' onblur=" validarTexto(this, 9)"><br>
