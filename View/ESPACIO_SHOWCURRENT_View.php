		...
		?>
			...
			<form name = 'Form' action='../Controller/ESPACIO_Controller.php' method='post' onsubmit="return comprobar_registro();">
					...
					<span class="trn">CODEDIFICIO</span> : 
						<input type = 'text' name = 'CODEDIFICIO' id = 'CODEDIFICIO' placeholder = 'Escribe el código del edificio' size = '9' value = '<?php echo $this->tupla['CODEDIFICIO']; ?>' readonly=""><br>

					<span class="trn">CODCENTRO</span> : 
						<input type = 'text' name = 'CODCENTRO' id = 'CODCENTRO' placeholder = 'Escribe el código del centro' size = '15' value = '<?php echo $this->tupla['CODCENTRO']; ?>'  readonly=""><br>
