		...
		?>
			...
			<form name = 'Form' action='../Controller/EDIFICIO_Controller.php' method='post' onsubmit="return comprobar_registro();">
					...
					<span class="trn">NOMBREEDIFICIO</span>:  
						<input type = 'text' name = 'NOMBREEDIFICIO' id = 'NOMBREEDIFICIO' placeholder = 'Escribe el nombre del edificio' size = '50' value =  '<?php echo $this->tupla['NOMBREEDIFICIO']; ?>' readonly><br>	

					<span class="trn">DIRECCIONEDIFICIO</span>:  
						<input type = 'text' name = 'DIRECCIONEDIFICIO' id = 'DIRECCIONEDIFICIO' placeholder = 'Escribe la direccion del edificio' size = '150' value =  '<?php echo $this->tupla['DIRECCIONEDIFICIO']; ?>' readonly><br>	
